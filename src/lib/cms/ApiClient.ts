...
import FeaturedFoundersCarouselGroq from './groq/FeaturedFoundersCarousel';
import PortfolioListingModuleGroq from './groq/PortfolioListingModule';
...
const ApiClient: {
  ...
  async fetchHome() {
    const response = await Sanity.fetch(`*[_type == 'home' && _id == '_home'][0] {
      ...
      'featuredFoundersCarousel': featuredFoundersCarousel${FeaturedFoundersCarouselGroq},
  ...
  async fetchCompaniesPage() {
    const response = await Sanity.fetch(`*[_type == 'companies' && _id == '_companies'][0] {
      ...
      'seo': ${SeoSettingsGroq},
      'hero': ${HeroTextModuleGroq},
      'portfolioListing': portfolioListing${PortfolioListingModuleGroq},
